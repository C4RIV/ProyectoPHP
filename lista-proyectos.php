...
<!-- termina la barra de botones lateral -->
            ...
            <main class="main-content p-5" role="main">
              <div class="row mb-5">
    						<div class="col-md-12">
    							<h2><center> Proyectos a Elegir </center></h2>
    						</div>
    						<div class="col-md-4 mb-5">
    							<div class="card">
    								<div class="card-header">
    									Logotipo empresa RetroCar
    								</div>
    								<div class="card-body">
    									<h4 class="card-title">Logotipo</h4>
    									<p class="card-text">Diseñar logotipo para la empresa RetroCar con 5 propuestas completamente distintas.</p>
    									<a href="#" class="btn btn-primary waves-effect waves-light">Dame el Proyecto</a>
    								</div>
                    <div class="card-footer text-muted">
    						...
    						<div class="col-md-4 mb-5">
    							<div class="card text-center">
    								...
    								<div class="card-body">
    									<h4 class="card-title">Contabilidad Completa</h4>
    									<p class="card-text">Prestigiosa empresa requiere Software Contable capas de manejar inventario y demás.</p>
    						...
    						<div class="col-md-4 mb-5">
    							<div class="card text-right">
    								...
    								<div class="card-body">
    									<h4 class="card-title">Para horus</h4>
    									<p class="card-text">Requerimos vídeo spot publicitario con los nuevos descuestos para usuarios comunes.</p>
    									<a href="#" class="btn btn-primary">
    										Dame el Proyecto
    									</a>
    								</div>
