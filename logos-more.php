				...
				<ul class="nav nav-pills flex-column">
					...
					<li class="nav-item">
						...
						<ul class="nav nav-pills flex-column">
							<li class="nav-item">
								<li class="nav-item">
									<a class="nav-link" href="task-manager.html">Logos y Demas</a>
								</li>
				...
				<main class="main-content p-5" role="main">
						...
						<div class="card bg-info bg-gradient mb-3 text-center">
							<div class="card-body">
								<blockquote class="blockquote">
									<img src="assets/img/logo-ok.png" width="500" height="500" alt="Logo-Horus">
									<p>Logotipo de la empresa a tu disposición</p>
									<footer>Recuerda: <cite title="Source Title">Click derecho y Guardar como...</cite></footer>
								</blockquote>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 mb-5">
						<div class="card bg-success bg-gradient mb-3 text-center">
							<div class="card-body">
								<blockquote class="blockquote">
									<img src="assets/img/logo-ok2.png" width="500" height="500" alt="Logo-Horus2">
									<p>Segundo Logotipo de la empresa a tu disposición.</p>
									<footer>Recuerda:<cite title="Source Title">Click derecho y Guardar como...</cite></footer>
								</blockquote>
							</div>
						</div>
