								...
								<div class="card-body">
									<div class="mb-4 clearfix">
										...
										<div class="float-right text-right">
											<h6 class="m-0">Seguidores en Twitter</h6>
										</div>
									</div>
									<div class="text-right clearfix">
										<div class="display-4">65,452</div>
										<div class="m-0">+72 Hoy</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card card-sm">
								<div class="card-body">
									<div class="mb-4 clearfix">
										...
										<div class="float-right text-right">
											<h6 class="m-0">Subscriptores Youtube</h6>
										</div>
									</div>
									<div class="text-right clearfix">
							...
							<div class="card card-sm bg-danger">
								<div class="card-body">
									<div class="mb-4 clearfix">
										...
										<div class="float-right text-right">
											<h6 class="m-0">Me Gustas Facebook</h6>
										</div>
									</div>
									<div class="text-right clearfix">
										<div class="display-4">231</div>
										<div class="m-0"> Hoy</div>
									</div>
								</div>
							</div>
						</div>
