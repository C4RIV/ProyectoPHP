...
<!-- Mirrored from base5builder.com/livedemo/quillpro/v1.7/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2019 22:02:02 GMT -->
<head>
...
<!-- termina la barra de botones lateral -->
			...
			<div class="right-column">
						...
						<ul class="navbar-nav ml-5 navbar-profile">
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbar-dropdown-navbar-profile">
									<li><a class="dropdown-item" href="profiles-member-profile.html">Perfil</a></li>
									<li>
								...
								<div class="card-body">
									<div class="row">
										<div class="conntainer">
											...
											<br>
											<div class="row mb-5 pb-5 clearfix qp-gallery-one">
												<div class="col-md-12">
													<h2><center>Imágenes a Disposición</center></h2>
												</div>
												<br>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-1.jpg">
															<img class="card-img" src="assets/img/gallery-image-1.jpg" alt="Gallery Image 1">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-2.jpg">
															<img class="card-img" src="assets/img/gallery-image-2.jpg" alt="Gallery Image 2">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-3.jpg">
															<img class="card-img" src="assets/img/gallery-image-3.jpg" alt="Gallery Image 3">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-4.jpg">
															<img class="card-img" src="assets/img/gallery-image-4.jpg" alt="Gallery Image 4">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-5.jpg">
															<img class="card-img" src="assets/img/gallery-image-5.jpg" alt="Gallery Image 5">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-6.jpg">
															<img class="card-img" src="assets/img/gallery-image-6.jpg" alt="Gallery Image 6">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-7.jpg">
															<img class="card-img" src="assets/img/gallery-image-7.jpg" alt="Gallery Image 7">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-8.jpg">
															<img class="card-img" src="assets/img/gallery-image-8.jpg" alt="Gallery Image 8">
														</a>
													</div>
												</div>
												<div class="col-sm-6 col-md-4 mb-5">
													<div class="card lightbox">
														<a href="assets/img/gallery-image-9.jpg">
															<img class="card-img" src="assets/img/gallery-image-9.jpg" alt="Gallery Image 9">
														</a>
													</div>
												</div>
											</div>
				...
				<div class="row mb-4">
					<div class="col-md-12">
						<footer>
							Powered by - <a href="https://www.facebook.com/horusservicesofficial/" target="_blank" style="font-weight:300;color:#ffffff;background:#1d1d1d;padding:0 3px;">Horus<span style="color:#ffa733;font-weight:bold">Services</span></a>
						</footer>
					</div>
				</div>
			</div>
...
<!-- Mirrored from base5builder.com/livedemo/quillpro/v1.7/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2019 22:03:27 GMT -->
</html>
