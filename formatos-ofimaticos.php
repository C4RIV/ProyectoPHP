              ...
              <div class="col-md-12 mb-5">
  							<div class="card">
  								<div class="card-header">
  									<center> Estamos trabajando en ello. </center>
  								</div>
  								<div class="card-body">
  									<blockquote class="blockquote">
  										<p>En el momento no contamos con ningún formato ofimático anexado directamente a nuestra plataforma.</p>
  										<footer>Pronto más información <cite title="Source Title">Queda atento!</cite></footer>
  									</blockquote>
  								</div>
  							</div>
  						</div>
